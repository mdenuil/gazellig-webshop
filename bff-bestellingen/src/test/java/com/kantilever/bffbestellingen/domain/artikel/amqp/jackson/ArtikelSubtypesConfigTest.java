...
class ArtikelSubtypesConfigTest {
    @MockBean
    private AuditReplayStartListener auditReplayStartListener;

    @Autowired
    private ArtikelSubtypesConfig artikelSubtypesConfig;
    ...
    void topicLoads() {
        // Arrange
        var expected = List.of("Kantilever.CatalogusService.ArtikelAanCatalogusToegevoegd");
        // Act
        // Assert
        assertThat(expected
                .contains(artikelSubtypesConfig.getTopicArtikelAanCatalogusToegevoegd()))
                .isTrue();
    }
    ...
    void subtypesRegistered() {
        // Arrange
        Set<Class<?>> registeredSubtypes = artikelSubtypesConfig.getEventSubtypeModule().getRegisteredSubtypes();
        // Act
        // Assert
        assertThat(registeredSubtypes.contains(ArtikelToegevoegdEvent.class)).isTrue();
    }
    ...
    void subtypeModuleRegistered() {
        ...
        // Act
        // Assert
        assertThat(registeredModuleIds.contains(ArtikelEvent.class)).isTrue();
    }
}