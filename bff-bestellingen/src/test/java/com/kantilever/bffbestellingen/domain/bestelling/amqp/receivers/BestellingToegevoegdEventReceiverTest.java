...
class BestellingToegevoegdEventReceiverTest {
    ...
    void topicLoaded() {
        // Arrange
        // Act
        var actual = bestellingToegevoegdEventReceiver.getTopic();
        // Assert
    ...
    void correctServiceFunctionCalled() {
        // Arrange
        var bestellingStatusEvent = ObjectBuilders.getDefaultBestellingEventBuilder()
                .build();
        // Act
        bestellingToegevoegdEventReceiver.receive(bestellingStatusEvent);
        // Assert
        verify(bestellingEventReceiverService, times(1)).handleBestellingToegevoegdEvent(bestellingStatusEvent);
    }
}